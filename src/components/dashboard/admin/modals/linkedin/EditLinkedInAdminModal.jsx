...
import EditLinkedInFilterOneAdminForm from "../../forms/linkedin/EditLinkedInFilterOneAdminForm";
import EditLinkedInFilterTwoAdminForm from "../../forms/linkedin/EditLinkedInFormTwoAdminForm";
import EditLinkedInFilterThreeAdminForm from "../../forms/linkedin/EditLinkedInFilterThreeAdminForm";
import EditLinkedInSubjectAndMessageAdminForm from "../../forms/linkedin/EditLinkedInSubjectAndMessageAdminForm";
    ...
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        {activeStep === steps.length ? (
          ...
          <React.Fragment>
            {activeStep === 0 && (
              <EditLinkedInFilterOneAdminForm
            ...
            {activeStep === 1 && (
              <EditLinkedInFilterTwoAdminForm
            ...
            {activeStep === 2 && (
              <EditLinkedInFilterThreeAdminForm
...
export default EditLinkedInAdminModal;
